...
$grpWs.Size = New-Object System.Drawing.Size(560, 150)
...
$lblWsNote = New-Label 'Выключение отрисовки убирает и UI-мод (порознь они не работают).' 12 112 540
$lblWsNote.ForeColor = [System.Drawing.Color]::DimGray

$grpWs.Controls.AddRange(@($chkWs, $lblRes, $cmbRes, $numW, $lblX, $numH, $lblTex, $radTexCustom, $radTexHard, $lblWsNote))
...
$grpCam.Text = 'Камера'
$grpCam.Location = New-Object System.Drawing.Point(12, 252)
...
$grpLang.Text = 'Язык'
$grpLang.Location = New-Object System.Drawing.Point(12, 342)
...
$btnApply.Location = New-Object System.Drawing.Point(12, 402)
...
$btnPlay.Location = New-Object System.Drawing.Point(160, 402)
...
$btnRestore.Location = New-Object System.Drawing.Point(432, 402)
...
$log.Location = New-Object System.Drawing.Point(12, 444)
$log.Size = New-Object System.Drawing.Size(560, 230)
